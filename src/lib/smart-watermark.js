...
let LightAdminWaterMarkIntervalId = null;
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        LightAdminWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (LightAdminWaterMarkIntervalId) {
            clearInterval(LightAdminWaterMarkIntervalId);
            LightAdminWaterMarkIntervalId = null;
        }
    },
};
