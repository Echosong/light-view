...
<a-form-item label="图片" v-if="!query.image" >
 <FileImage :key="m.image" @onremove="m.image = ''" @onSuccess="m.image = $event" :file="m.image" />
</a-form-item>
...
const rules = {position:[ {required: true, message: '请输入位置', trigger: 'blur' },],
