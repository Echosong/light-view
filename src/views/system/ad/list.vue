...
const columns = ref([{
  ...
  "ellipsis": true,
  "align": "left"
}, {"title": "名称", "dataIndex": "name", "ellipsis": true, "align": "left"}, {
  "title": "关联代码",
  "dataIndex": "relationCode",
  "ellipsis": true,
  "align": "left"
}, {"title": "图片", "dataIndex": "image", "ellipsis": true, "align": "left"}, {
  "title": "跳转位置",
  "dataIndex": "url",
  "ellipsis": true,
  "align": "left"
}, {"title": "状态", "dataIndex": "stateEnum", "ellipsis": true, "align": "left"}, {
  "title": "关联的实体",
  "dataIndex": "info",
  "ellipsis": true,
  "align": "left"
}, {"title": "操作", "dataIndex": "action", "ellipsis": true, "align": "left", "width": 90, "fixed": "right"}]);
...
function exportFile() {
  base.download("/ad/export", p.value)
}
