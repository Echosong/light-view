...
<template>
  <a-modal v-model:open="visible" :title="formState.departmentId ? '编辑部门' : '添加部门'" @ok="handleOk" destroyOnClose>
    <a-form ref="formRef" :model="formState" :rules="rules" layout="horizontal"  class="es-form"
      :label-col="{span: 5 }"
    >
      ...
      <a-form-item label="部门名称" name="name" labelAlign="right" tooltip="请输入部门名称">
      ...
      <a-form-item label="部门排序" name="sort" tooltip="（值越大越靠前！）">
