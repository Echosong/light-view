  ...
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      ...
      <a-form-item label="类型" v-if="!query.type" class="smart-query-form-item">
        <input-enum style="width: 120px;" enumName="articleTypeEnum" v-model="p.type"></input-enum>
      </a-form-item>
      <a-form-item label="发布时间" v-if="!query.publishTime" class="smart-query-form-item">
        <a-range-picker @change="(rangDate)=> {p.startPublishTime = rangDate[0];p.endPublishTime = rangDate[1];}"
...
const columns = ref([{"title": "标题", "dataIndex": "title", "ellipsis": true, "align": "left"}, {
  "title": "类型",
  "dataIndex": "typeEnum",
  "ellipsis": true,
  "align": "left"
}, {"title": "内容", "dataIndex": "content", "ellipsis": true, "align": "left"}, {
  "title": "附件",
  "dataIndex": "fileUrl",
  "ellipsis": true,
  "align": "left"
