...
<template>
  <a-drawer
    ...
    destroyOnClose
  >
    <a-alert message="超管需要直接在数据库表 t_employee修改哦" type="error"  />
    <br />
    <a-form ref="formRef" :model="form" :rules="rules"  layout="horizontal" :label-col="{span: 5 }">
      ...
      <a-form-item label="登录名" name="loginName" tooltip="初始密码默认为：随机">
